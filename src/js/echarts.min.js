...
function(t, e) {
	...
	function rt(t, e, i, n) {
		return i = i || {}, n || !z_.canvasSupported ? st(t, e, i) : z_.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (i.zrX = e.layerX, i.zrY = e.layerY) : null != e.offsetX ? (i.zrX = e.offsetX, i.zrY = e.offsetY) : st(t, e, i), i
	}
	function st(t, e, i) {
		var n = at(t);
	...
	function Zt(t, e, i, n) {
		if (t = zt(t)) return t = Vt(t), null != e && (t[0] = Dt(e)), null != i && (t[1] = kt(i)), null != n && (t[2] = kt(n)), Xt(Bt(t), "rgba")
	}
	function Ut(t, e) {
	...
	function be(t, e, i) {
		var n = Y_(),
			...
			a = e.getHeight(),
			r = n.style;
		return r && (r.position = "absolute", r.left = 0, r.top = 0, r.width = "100%", r.height = "100%", n.setAttribute("data-zr-dom-id", t)), n.width = o * i, n.height = a * i, n
	}
	function Se(t) {
		if ("string" == typeof t) {
			var e = ob.get(t);
	...
	function Ye(t, e, i, n, o, a) {
		...
		else for (var R = 0; R < f.length; R++) O && e.strokeText(f[R], w, b), E && e.fillText(f[R], w, b), b += p
	}
	...
	function fi(t, e, i) {
		return mb.copy(t.getBoundingRect()), t.transform && mb.applyTransform(t.transform), vb.width = e, vb.height = i, !mb.intersect(vb)
	}
	function pi(t, e) {
		if (t == e) return !1;
	...
	function mi(t, e) {
		...
		return i.style.cssText = ["position:relative", "overflow:hidden", "width:100%", "height:100%", "padding:0", "margin:0", "border-width:0"].join(";") + ";", i
	}
	function vi(t) {
		var e = t[1][0] - t[0][0],
			i = t[1][1] - t[0][1];
		...
		return Nb(e, function(t, n) {
			if (Ob(t)) {
				...
				for (var o = 0; o < i.length; o++) {
					var a = i[o].exist;
					if (!(i[o].option || null != a.id && null != t.id || null == t.name || Ei(t) || Ei(a) || a.name !== t.name + "")) return i[o].option = t, void(e[n] = null)
				}
			}
		}), Nb(e, function(t, e) {
			if (Ob(t)) {
	...
	function Ri(t, e) {
		function i(t, e, i) {
			for (var n = 0, o = t.length; n < o; n++) for (var a = t[n].seriesId, r = Di(t[n].dataIndex), s = i && i[a], l = 0, u = r.length; l < u; l++) {
				var h = r[l];
	...
	function ia(t, e) {
		var i = (t = _(t) ? {
			...
			o = t.renderMode || "html",
			a = t.markerId || "X";
		return i ? "html" === o ? "subItem" === n ? '<span style="display:inline-block;vertical-align:middle;margin-right:8px;margin-left:3px;border-radius:4px;width:4px;height:4px;background-color:' + Qo(i) + ";" + (e || "") + '"></span>' : '<span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:' + Qo(i) + ";" + (e || "") + '"></span>' : {
			renderMode: o,
			content: "{marker" + a + "|}  ",
			style: {
				color: i
	...
	function sa(t, e, i) {
		var n = e.width,
			...
			s = Ro(t.x2, n),
			l = Ro(t.y2, o);
		return (isNaN(a) || isNaN(parseFloat(t.x))) && (a = 0), (isNaN(s) || isNaN(parseFloat(t.x2))) && (s = n), (isNaN(r) || isNaN(parseFloat(t.y))) && (r = 0), (isNaN(l) || isNaN(parseFloat(t.y2))) && (l = o), i = OM(i || 0), {
	...
	function Ua(t) {
		var e = t && t.itemStyle;
		if (e) for (var i = 0, o = _I.length; i < o; i++) {
			var a = _I[i],
				r = e.normal,
				s = e.emphasis;
	...
	function ja(t) {
		Xa(t, "itemStyle"), Xa(t, "lineStyle"), Xa(t, "areaStyle"), Xa(t, "label"), Xa(t, "labelLine"), Xa(t, "upperLabel"), Xa(t, "edgeLabel")
	}
	function Ya(t, e) {
		var i = xI(t) && t[e],
			n = xI(i) && i.textStyle;
		if (n) for (var o = 0, a = zb.length; o < a; o++) {
			var e = zb[o];
	...
	function Ka(t) {
		if (xI(t)) {
			...
			if ((e = t.markPoint) && e.data) for (var r = e.data, s = 0; s < r.length; s++) qa(r[s]);
			if ((i = t.markLine) && i.data) for (var l = i.data, s = 0; s < l.length; s++) y(l[s]) ? (qa(l[s][0]), qa(l[s][1])) : qa(l[s]);
			"gauge" === t.type ? (Ya(t, "axisLabel"), Ya(t, "title"), Ya(t, "detail")) : "treemap" === t.type ? (Xa(t.breadcrumb, "itemStyle"), d(t.levels, function(t) {
				ja(t)
	...
	function Jr(t, e, i, n) {
		...
		}), o.textBaseline && "auto" !== o.textBaseline || (o.textBaseline = "alphabetic"), "alphabetic" === o.textBaseline && (o.textBaseline = "bottom"), "start" === o.textAlign && (o.textAlign = "left"), "end" === o.textAlign && (o.textAlign = "right"), d(["lineDashOffset", "lineCap", "lineJoin", "fontWeight", "fontFamily", "fontStyle", "textAlign", "textBaseline"], function(t) {
			null != o[t] && c.set(t, o[t])
		}), o.lineDash && (e.style.lineDash = P(o.lineDash).split(rT)), c[h] && "none" !== c[h] && (e[h] = !0), e.__inheritedStyle = o
	}
	function Qr(t, e) {
	...
	function cs(t, e) {
		...
		vT(h, function(t) {
			d = o.action(t, this._model, this._api), (d = d || a({}, t)).type = s.event || d.type, p.push(d), g ? us(this, u, t, "series") : l && us(this, u, t, l.main, l.sub)
		}, this), "none" === u || g || l || (this[AT] ? (ls(this), LT.update.call(this, t), this[AT] = !1) : LT[u].call(this, t)), d = c ? {
			type: s.event || i,
			escapeConnect: n,
			batch: p
	...
	function ps(t, e) {
		t.on("rendered", function() {
			e.trigger("rendered"), !t.animation.isFinished() || e[AT] || e._scheduler.unfinished || e._pendingActions.length || e.trigger("finished")
		})
	}
	function gs(t, e, i, n) {
		function o(t) {
	...
	function bl(t, e) {
		!isFinite(t[0]) && (t[0] = e[0]), !isFinite(t[1]) && (t[1] = e[1]), wl(t, 0, e), wl(t, 1, e), t[0] > t[1] && (t[0] = t[1])
	}
	function Sl(t, e, i, n) {
		var o = [];
		if (!t) return o;
	...
	function Rl(t, e) {
		var i, n, o, a = t.type,
			...
			u = null != s,
			h = t.getExtent();
		"ordinal" === a ? i = e.getCategories().length : (y(n = e.get("boundaryGap")) || (n = [n || 0, n || 0]), "boolean" == typeof n[0] && (n = [0, 0]), n[0] = Ro(n[0], 1), n[1] = Ro(n[1], 1), o = h[1] - h[0] || Math.abs(h[0])), null == r && (r = "ordinal" === a ? i ? 0 : NaN : h[0] - n[0] * o), null == s && (s = "ordinal" === a ? i ? i - 1 : NaN : h[1] + n[1] * o), "dataMin" === r ? r = h[0] : "function" == typeof r && (r = r({
			min: h[0],
			max: h[1]
	...
	function Xl(t, e, i, n, o, a, r) {
		...
		var l;
		return l = 0 === t.indexOf("image://") ? Hn(t.slice(8), new ue(e, i, n, o), r ? "center" : "cover") : 0 === t.indexOf("path://") ? Wn(t.slice(7), {}, new ue(e, i, n, o), r ? "center" : "cover") : new RA({
			shape: {
				symbolType: t,
				x: e,
				y: i,
	...
	function ch(t, e, i) {
		...
		if (T(i.axisLabelShow, e.get("axisLabel.show")) && !n.scale.isBlank()) {
			...
			return d(r, function(r, s) {
				...
				}), f && (x.eventData = nh(e), x.eventData.targetType = "axisLabel", x.eventData.value = g), t._dumbGroup.add(x), x.updateTransform(), h.push(x), t.group.add(x), x.decomposeTransform()
			}), h
		}
	}
	function dh(t, e) {
	...
	function ph(t, e, n, o, a, s) {
		var l = e.getModel("axisPointer"),
			u = {};
		DD(["type", "snap", "lineStyle", "shadowStyle", "label", "animation", "animationDurationUpdate", "animationEasingUpdate", "z"], function(t) {
			u[t] = i(l.get(t))
	...
	function Uh(t) {
		this.name = t, this.zoomLimit, mw.call(this), this._roamTransformable = new Zh, this._rawTransformable = new Zh, this._center, this._zoom
	}
	function Xh(t, e, i, n) {
		var o = i.seriesModel,
	...
	function _c(t, e) {
		...
		this.uid = No("ec_map_draw"), this._controller = new ac(t.getZr()), this._controllerHost = {
			target: e ? i : null
		}, this.group = i, this._updateGroup = e, this._mouseDownFlag, this._mapName, this._initialized, i.add(this._regionsGroup = new Zw), i.add(this._backgroundGroup = new Zw)
	}
	function wc(t, e, i) {
		var n = t.getZoom(),
			o = t.getCenter(),
	...
	function Lc(t, e, i, n) {
		i[IC][e] = t, t[TC] = i, t.dataType = e, n.struct && (t[n.structAttr] = n.struct, n.struct[n.datasAttr[e]] = t), t.getLinkedData = Ac
	}
	function kc(t, e, i) {
	...
	function Yc(t, e, i, n, o, a) {
		var s = !i,
			...
			p = l.getLayout();
		s ? (i = new mu(t, e, a)).attr("position", [f.x, f.y]) : i.updateData(t, e, a), i.__radialOldRawX = i.__radialRawX, i.__radialOldRawY = i.__radialRawY, i.__radialRawX = p.rawX, i.__radialRawY = p.rawY, n.add(i), t.setItemGraphicEl(e, i), bo(i, {
			position: [p.x, p.y]
		}, o);
	...
	function Qc(t, e) {
		...
		if (l) {
			...
			if ("radial" === n) p = o / (h.getLayout().x + d + f), g = a / (c.depth - 1 || 1), Jc(l, function(t) {
				...
				})) : "TB" !== y && "BT" !== y || (p = o / (h.getLayout().x + d + f), g = a / (c.depth - 1 || 1), Jc(l, function(t) {
	...
	function Cf(t) {
		aw.call(this), this._zr = t, this.group = new Zw, this._brushType, this._brushOption, this._panels, this._track = [], this._dragging, this._covers = [], this._creatingCover, this._creatingPanel, this._enableGlobalPan, this._uid = "brushController_" + ok++, this._handlers = {}, XL(ak, function(t, e) {
	...
	function hp(t) {
		return t = fp(t), function(e, i) {
			return Do(e, t)
		}
	}
	function cp(t, e) {
		return t = fp(t), function(i) {
			var n = null != e ? e : i,
	...
	function Fg(t, e, i, n, o, a) {
		e && t.attr(e), n.symbolClip && !o ? i && t.attr(i) : i && bM[o ? "updateProps" : "initProps"](t, i, n.animationModel, n.dataIndex, a)
	}
	function Wg(t, e, i) {
		var n = i.color,
			o = i.dataIndex,
	...
	function xm(t, e, i) {
		var n = mt();
		return wt(n, n, i.rotation), _t(n, n, i.position), Io([t.dataToCoord(e), (i.labelOffset || 0) + (i.labelDirection || 1) * (i.labelMargin || 0)], n)
	}
	...
	function Um(t, e, i, n) {
		function o(t) {
			null == t && (t = h), v && (c = e.getItemModel(t), d = c.getModel(AP), f = c.getModel(DP), p = e.getItemVisual(t, "color"), v = !1)
		}
		...
		var h, c, d, f, p, g = r({
			...
			styleEmphasis: function(i, n) {
				...
				return fo(r, f, null, {
					isRectText: !0
				}, !0), r.text = f.getShallow("show") ? D(t.getFormattedLabel(n, "emphasis"), t.getFormattedLabel(n, "normal"), gu(e, n)) : null, i && a(r, i), r
			},
			visual: function(t, i) {
	...
	function rx(t, e, i, n) {
		var o = {};
		return null != t.valueIndex || null != t.valueDim ? (o.valueDataDim = null != t.valueIndex ? e.getDimension(t.valueIndex) : t.valueDim, o.valueAxis = i.getAxis(sx(n, o.valueDataDim)), o.baseAxis = i.getOtherAxis(o.valueAxis), o.baseDataDim = e.mapDimension(o.baseAxis.dim)) : (o.baseAxis = n.getBaseAxis(), o.valueAxis = i.getOtherAxis(o.baseAxis), o.baseDataDim = e.mapDimension(o.baseAxis.dim), o.valueDataDim = e.mapDimension(o.valueAxis.dim)), o
	}
	function sx(t, e) {
		var i = t.getData(),
			n = i.dimensions;
	...
	var hw = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
		cw = function(t, e, i, n) {
			aw.call(this), this.storage = t, this.painter = e, this.painterRoot = n, i = i || new pt, this.proxy = null, this._hovered = {}, this._lastTouchMoment, this._lastX, this._lastY, it.call(this), this.setHandlerProxy(i)
		};
	cw.prototype = {
		constructor: cw,
	...
	var Aw = {
		...
		Ow = function(t, e, i, n) {
			this._tracks = {}, this._target = t, this._loop = e || !1, this._getter = i || jt, this._setter = n || Yt, this._clipCount = 0, this._delay = 0, this._doneList = [], this._onframeList = [], this._clipList = []
		};
	Ow.prototype = {
		when: function(t, e) {
			var i = this._tracks;
		...
		clear: function(t, e) {
			...
			if (r && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(i, 0, 0, o / l, a / l)), n.clearRect(0, 0, o, a), e && "transparent" !== e) {
				...
				e.colorStops ? (u = e.__canvasGradient || $w.getGradient(n, e, {
					...
					width: o,
					height: a
				}), e.__canvasGradient = u) : e.image && (u = eb.prototype.getCanvasPattern.call(e, n)), n.save(), n.fillStyle = u || e, n.fillRect(0, 0, o, a), n.restore()
			}
			if (r) {
				var h = this.domBack;
	...
	function(t) {
		setTimeout(t, 16)
	}, ob = new Iw(50), ab = {}, rb = 0, sb = 5e3, lb = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, ub = "12px sans-serif", hb = {};
	...
	yb.prototype = {
		...
		getLayer: function(t, e) {
			...
			return i || ((i = new ib("zr_" + t, this, this.dpr)).zlevel = t, i.__builtin__ = !0, this._layerConfig[t] && n(i, this._layerConfig[t], !0), e && (i.virtual = e), this.insertLayer(t, i), i.initContext()), i
		},
	...
	var xb = function(t) {
			...
			function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, aw.call(this)
		};
	xb.prototype = {
		constructor: xb,
		addClip: function(t) {
	...
	MS.prototype = {
		...
		moveTo: function(t, e) {
			return this.addData(dS.M, t, e), this._ctx && this._ctx.moveTo(t, e), this._x0 = t, this._y0 = e, this._xi = t, this._yi = e, this
		},
		lineTo: function(t, e) {
			var i = bS(t - this._xi) > this._ux || bS(e - this._yi) > this._uy || this._len < 5;
			return this.addData(dS.L, t, e), this._ctx && i && (this._needsDash() ? this._dashedLineTo(t, e) : this._ctx.lineTo(t, e)), i && (this._xi = t, this._yi = e), this
		},
		bezierCurveTo: function(t, e, i, n, o, a) {
			return this.addData(dS.C, t, e, i, n, o, a), this._ctx && (this._needsDash() ? this._dashedBezierTo(t, e, i, n, o, a) : this._ctx.bezierCurveTo(t, e, i, n, o, a)), this._xi = o, this._yi = a, this
		},
		quadraticCurveTo: function(t, e, i, n) {
			return this.addData(dS.Q, t, e, i, n), this._ctx && (this._needsDash() ? this._dashedQuadraticTo(t, e, i, n) : this._ctx.quadraticCurveTo(t, e, i, n)), this._xi = i, this._yi = n, this
		},
		arc: function(t, e, i, n, o, a) {
			return this.addData(dS.A, t, e, i, i, n, o - n, 0, a ? 0 : 1), this._ctx && this._ctx.arc(t, e, i, n, o, a), this._xi = xS(o) * i + t, this._yi = _S(o) * i + e, this
		},
	...
	var dM = function(t, e, i, n, o, a) {
			this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == i ? 1 : i, this.y2 = null == n ? 0 : n, this.type = "linear", this.global = a || !1, cM.call(this, o)
		};
	dM.prototype = {
		constructor: dM
	}, u(dM, cM);
	var fM = function(t, e, i, n, o) {
			this.x = null == t ? .5 : t, this.y = null == e ? .5 : e, this.r = null == i ? .5 : i, this.type = "radial", this.global = o || !1, cM.call(this, n)
		};
	fM.prototype = {
		constructor: fM
	...
	Va.prototype = {
		...
		mountOption: function(t) {
			...
			return this._timelineOptions = gI(e.timelineOptions, pI), this._mediaList = gI(e.mediaList, pI), this._mediaDefault = pI(e.mediaDefault), this._currentMediaIndices = [], pI(t ? e.baseOption : this._newBaseOption)
		},
	...
	var TI = {
		...
		DI = {
			...
			original: function(t, e, i, n) {
				...
				return !this._rawData.pure && ki(t) && (this.hasItemOption = !0), ur(o instanceof Array ? o[n] : o, this._dimensionInfos[e])
			},
	...
	CT._onframe = function() {
		...
		if (z_.canvasSupported) return (t = t || {}).pixelRatio = t.pixelRatio || 1, t.backgroundColor = t.backgroundColor || this._model.get("backgroundColor"), this._zr.painter.getRenderedCanvas(t)
	...
	}, iA.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"], iA.CHANGABLE_METHODS = ["filterSelf", "selectRange"];
	var oA = function(t, e) {
	...
	ql.prototype = {
		...
		getBoundingRect: function() {
			var t = this._rect;
			if (t) return t;
			for (var e = Number.MAX_VALUE, i = [e, e], n = [-e, -e], o = [], a = [], r = this.geometries, s = 0; s < r.length; s++)"polygon" === r[s].type && (dn(r[s].exterior, o, a), tt(i, i, o), et(n, n, a));
	...
	jA._updateCommon = function(t, e, i, n) {
		...
		co(v, u, d, f, {
			...
			isRectText: !0,
			autoColor: s
		}), o.off("mouseover").off("mouseout").off("emphasis").off("normal"), o.hoverStyle = u, uo(o), o.__symbolOriginalScale = vu(i), p && r.isAnimationEnabled() && o.on("mouseover", xu).on("mouseout", _u).on("emphasis", wu).on("normal", bu)
	...
	Mr.extend({
		...
		_updateAnimation: function(t, e, i, n, o, a) {
			var r = this._polyline,
				...
				d = u.next,
				f = u.stackedOnNext;
			o && (h = Hu(u.current, i, o), c = Hu(u.stackedOnCurrent, i, o), d = Hu(u.next, i, o), f = Hu(u.stackedOnNext, i, o)), r.shape.__points = u.current, r.shape.points = h, bo(r, {
				shape: {
					points: d
				}
			}, l), s && (s.setShape({
	...
	var TD = {
		...
		axisName: function() {
			...
			if (i) {
				...
				}), e.get("triggerEvent") && (b.eventData = nh(e), b.eventData.targetType = "axisName", b.eventData.name = i), this._dumbGroup.add(b), b.updateTransform(), this.group.add(b), b.decomposeTransform()
			}
		}
	},
		...
		_renderNormal: function(t, e, i) {
			...
			a.diff(r).add(function(e) {
				...
				if (a.hasValue(e)) {
					...
					l ? bo(l, {
						shape: c
					}, u, e) : l = VD[s.type](a, e, h, c, n, u, !0), a.setItemGraphicEl(e, l), o.add(l), Lh(l, a, e, h, c, t, n, "polar" === s.type)
				} else o.remove(l)
			}).remove(function(t) {
	...
	Fs({
		...
		render: function(t, e, n) {
			...
			h.diff(c).add(function(e) {
				...
				}), t.off("mouseover").off("mouseout").off("normal").off("emphasis"), t.on("emphasis", n).on("mouseover", n).on("normal", o).on("mouseout", o), uo(t)
			}), this._data = h
		},
		remove: function() {
	...
	], rC = 0; rC < aC.length; rC++) for (var sC = 0; sC < aC[rC].length; sC++) aC[rC][sC][0] /= 10.5, aC[rC][sC][1] /= -14, aC[rC][sC][0] += oC[0], aC[rC][sC][1] += oC[1];
	var lC = function(t, e) {
	...
	_c.prototype = {
		...
		remove: function() {
			this._regionsGroup.removeAll(), this._backgroundGroup.removeAll(), this._controller.dispose(), this._mapName && xC.removeGraphic(this._mapName, this.uid), this._mapName = null, this._controllerHost = {}
		},
	...
	AC.prototype = {
		...
		render: function(t, e, i, n) {
			...
			o.diff(l).add(function(e) {
				...
				i && qc(l, e, i, r, t, u)
			}).execute(), this._nodeScaleRatio = t.get("nodeScaleRatio"), this._updateNodeAndLinkScale(t), !0 === u.expandAndCollapse && o.eachItemGraphicEl(function(e, n) {
		...
		_updateViewCoordSys: function(t) {
			...
			a.zoomLimit = t.get("scaleLimit"), a.setBoundingRect(n[0], n[1], o[0] - n[0], o[1] - n[1]), a.setCenter(t.get("center")), a.setZoom(t.get("zoom")), this.group.attr({
				position: a.position,
				scale: a.scale
	...
	Fs({
		...
		_giveContainerGroup: function(t) {
			...
			return e || (e = this._containerGroup = new LC, this._initEvents(e), this.group.add(e)), e.attr("position", [t.x, t.y]), e
		},
	...
	Fs({
		...
		_updateController: function(t, e, i) {
			...
			n.setPointerChecker(function(e, n, o) {
				var r = a.getBoundingRect();
				return r.applyTransform(a.transform), r.contain(n, o) && !mc(e, i, t)
			}), "view" === t.coordinateSystem.type ? (n.enable(t.get("roam")), o.zoomLimit = t.get("scaleLimit"), o.zoom = t.coordinateSystem.getZoom(), n.off("pan").off("zoom").on("pan", function(e) {
				pc(o, e.dx, e.dy), i.dispatchAction({
					seriesId: t.id,
					type: "graphRoam",
					dx: e.dx,
			...
			_renderPointer: function(t, e, i, n, o, a, r, s) {
				...
				if (t.get("pointer.show")) {
					...
					d.diff(u).add(function(e) {
						...
						}), t.useStyle(i.getModel("itemStyle").getItemStyle()), "auto" === t.style.fill && t.setStyle("fill", n(Eo(d.get(f, e), h, [0, 1], !0))), uo(t, i.getModel("emphasis.itemStyle").getItemStyle())
					}), this._data = d
	...
	PL.updateData = function(t, e, i) {
		...
		n.setStyle(r({
			lineJoin: "round",
			fill: h
		}, u.getItemStyle(["opacity"]))), n.hoverStyle = u.getModel("emphasis").getItemStyle(), this._updateLabel(t, e), uo(this)
	...
	var ak = {
		...
		lk = Vs({
			type: "parallelAxis",
			init: function(t, e) {
				lk.superApply(this, "init", arguments), (this._brushController = new Cf(e.getZr())).on("brush", m(this._onBrush, this))
			},
			render: function(t, e, i, n) {
				if (!pp(t, e, n)) {
		...
		render: function(t, e, i) {
			...
			this._model = t, a.removeAll(), a.attr("position", [r.x, r.y]), o.eachEdge(function(e) {
				...
				co(d.style, f, h, c, {
					...
					defaultText: e.id,
					isRectText: !0
				}), d.setStyle("fill", e.getVisual("color")), uo(d, f), a.add(d), u.setItemGraphicEl(e.dataIndex, d), d.dataType = "node"
				...
				}, e.draggable = !0, e.cursor = "move"), a.get("focusNodeAdjacency") && (e.off("mouseover").on("mouseover", function() {
		...
		_renderOnCartesianAndCalendar: function(t, e, i, n, o) {
			...
			for (var c = this.group, d = t.getData(), f = t.getModel("itemStyle").getItemStyle(["color"]), p = t.getModel("emphasis.itemStyle").getItemStyle(), g = t.getModel("label"), m = t.getModel("emphasis.label"), v = l.type, y = "cartesian2d" === v ? [d.mapDimension("x"), d.mapDimension("y"), d.mapDimension("value")] : [d.mapDimension("time"), d.mapDimension("value")], x = i; x < n; x++) {
				...
				S && null != S[2] && (M = S[2]), co(f, p, g, m, {
					...
					defaultText: M,
					isRectText: !0
				}), _.setStyle(f), uo(_, d.hasItemOption ? p : a({}, p)), _.incremental = o, o && (_.useHoverLayer = !0), c.add(_), d.setItemGraphicEl(x, _)
			}
		},
	...
	OI.extend({
		...
		filterForExposedEvent: function(t, e, i, n) {
			...
			for (;
			(i = i.parent) && i !== this.group;) if (i.name === o) return !0;
			return !1
		}
	}), Ls(function(t) {
		var e = t.graphic;
		...
		RP = Vs({
			...
			_createItem: function(t, e, i, n, o, r, s, l, u) {
				...
				var w = "left" === s ? h + 5 : -5,
					...
					S = n.get("formatter"),
					M = t;
				"string" == typeof S && S ? M = S.replace("{name}", null != t ? t : "") : "function" == typeof S && (M = S(t)), g.add(new qS({
					style: fo({}, m, {
						text: M,
						x: w,
						y: c / 2,
	...
	var zP = PP.extend({
		...
		FP = RP.extend({
			...
			newlineDisabled: !0,
			init: function() {
				FP.superCall(this, "init"), this._currentIndex = 0, this.group.add(this._containerGroup = new BP), this._containerGroup.add(this.getContentGroup()), this.group.add(this._controllerGroup = new BP), this._showController
			},
			resetInner: function() {
				FP.superCall(this, "resetInner"), this._controllerGroup.removeAll(), this._containerGroup.removeClipPath(), this._containerGroup.__rectSize = null
			},
			renderInner: function(t, e, i, n) {
				function o(t, i) {
					var o = t + "DataIndex",
	...
	Vs({
		...
		manuallyHideTip: function(t, e, i, n) {
			...
			!this._alwaysShowContent && this._tooltipModel && o.hideLater(this._tooltipModel.get("hideDelay")), this._lastX = this._lastY = null, n.from !== this.uid && this._hide(Mv(n, i))
		},
	...
	var KP = function(t) {
			this.name = t || "", this.cx = 0, this.cy = 0, this._radiusAxis = new Pv, this._angleAxis = new Nv, this._radiusAxis.polar = this._angleAxis.polar = this
		};
	KP.prototype = {
		type: "polar",
		axisPointerEnabled: !0,
	...
	LD.registerAxisPointerClass("PolarAxisPointer", nN), Os(v(function(t, e, i) {
		...
		optionUpdated: function() {
			var t = this.option,
				e = this;
			t.regions = _C.getFilledRegions(t.regions, t.map, t.nameMap), this._optionModelMap = p(t.regions || [], function(t, i) {
	...
	Vs({
		type: "brush",
		init: function(t, e) {
			this.ecModel = t, this.api = e, this.model, (this._brushController = new Cf(e.getZr())).on("brush", m(this._onBrush, this)).mount()
		},
		render: function(t) {
	...
	var RN = d,
		...
		YN = VN.extend({
			...
			render: function(t, e, i, n) {
				YN.superApply(this, "render", arguments), Lr(this, "_dispatchZoomAction", this.dataZoomModel.get("throttle"), "fixRate"), this._orient = t.get("orient"), !1 !== this.dataZoomModel.get("show") ? (n && "dataZoom" === n.type && n.from === this.uid || this._buildView(), this._updateView()) : this.group.removeAll()
			},
			remove: function() {
	...
	Es(iO, {
		...
		reset: function(t, e) {
			...
			return e.eachComponent("visualMap", function(e) {
				...
				!e.isTargetSeries(t) || n && n.large || i.push(qv(e.stateList, e.targetVisuals, m(e.getValueState, e), e.getDataDimension(t.getData())))
			}), i
		}
	}), Es(iO, {
		createOnAllSeries: !0,
	...
	var nO = {
			...
			completeVisualOption: function() {
				...
				t.call(this, r), t.call(this, s), function(t, e, i) {
					...
					lO(this.stateList, function(a) {
						...
						s || (s = t[a] = {
							color: l ? o : [o]
						}), null == s.symbol && (s.symbol = e && i(e) || (l ? "roundRect" : ["roundRect"])), null == s.symbolSize && (s.symbolSize = n && i(n) || (l ? r[0] : [r[0], r[0]])), s.symbol = aO(s.symbol, function(t) {
		...
		pO = dO.extend({
			...
			resetItemSize: function() {
				...
				var t = this.itemSize;
				"horizontal" === this._orient && t.reverse(), (null == t[0] || isNaN(t[0])) && (t[0] = fO[0]), (null == t[1] || isNaN(t[1])) && (t[1] = fO[1])
			},
		...
		bO = gO.extend({
			type: "visualMap.continuous",
			init: function() {
				bO.superApply(this, "init", arguments), this._shapes = {}, this._dataInterval = [], this._handleEnds = [], this._orient, this._useHandle, this._hoverLinkDataIndices = [], this._dragging, this._hovering
			},
	...
	RO.extend({
		...
		_renderCurrentPointer: function(t, e, i, n) {
			var o = n.getData(),
				...
				l = {
					onCreate: function(t) {
						t.draggable = !0, t.drift = BO(s._handlePointerDrag, s), t.ondragend = BO(s._handlePointerDragend, s), Lx(t, a, i, n, !0)
					},
					onUpdate: function(t) {
						Lx(t, a, i, n)
					}
	...
	Vs({
		...
		render: function(t, e, i, n) {
			...
			if (r.removeAll(), t.get("show")) {
				...
				d(l, function(t, e) {
					h.push(e)
				}), new Hs(this._featureNames || [], h).add(o).update(o).remove(v(o, null)).execute(), this._featureNames = h, dv(r, t, i), r.add(fv(r.getBoundingRect(), t)), r.eachChild(function(t) {
					var e = t.__title,
						n = t.hoverStyle;
					if (n && e) {
						var o = De(e, He(n)),
	...
	Hx.defaultOption = {
		...
		}), v.innerHTML = s[1], y.innerHTML = s[2], y.style.cssText = m, v.style.cssText = m, !o.get("readOnly") && g.appendChild(y), g.appendChild(v), ut(u, "keydown", function(t) {
	...
	iE._onBrush = function(t, e) {
		function i(t, e, i) {
			...
			null == u.minValueSpan && null == u.maxValueSpan || (i = EL(0, i.slice(), r.scale.getExtent(), 0, u.minValueSpan, u.maxValueSpan)), l && (o[l.id] = {
				dataZoomId: l.id,
				startValue: i[0],
				endValue: i[1]
			})
	...
	if (!z_.canvasSupported) {
		var vE = 21600,
			yE = vE / 2,
			xE = function(t) {
				t.style.cssText = "position:absolute;left:0;top:0;width:1px;height:1px;", t.coordsize = vE + "," + vE, t.coordorigin = "0,0"
			},
			_E = function(t) {
			...
			CE = function(t, e) {
				null != e.lineDash && (t.dashstyle = e.lineDash.join(" ")), null == e.stroke || e.stroke instanceof cM || TE(t, e.stroke, e.opacity)
			},
			LE = function(t, e, i, n) {
				var o = "fill" == e,
				...
				if (v) {
					if (e && i) N.width = cE(b * e * c / f) + "px", N.height = cE(S * i * d / p) + "px";
						...
						var O = new Image,
							E = this;
						O.onload = function() {
							O.onload = null, e = O.width, i = O.height, N.width = cE(b * e * c / f) + "px", N.height = cE(S * i * d / p) + "px", E._imageWidth = e, E._imageHeight = i, E._imageSrc = o
						}, O.src = o
					}
	...
	}, t.registerLayout = Os, t.registerVisual = Es, t.registerLoading = zs, t.extendComponentModel = Bs, t.extendComponentView = Vs, t.extendSeriesModel = Gs, t.extendChartView = Fs, t.setCanvasCreator = function(t) {
		e("createCanvas", t)
	...
	}, t.dataTool = XT, t.zrender = Pb, t.number = NM, t.format = FM, t.throttle = Cr, t.helper = BA, t.matrix = fw, t.vector = nw, t.color = Pw, t.parseGeoJSON = GA, t.parseGeoJson = ZA, t.util = UA, t.graphic = XA, t.List = eA, t.Model = Lo, t.Axis = HA, t.env = z_
});